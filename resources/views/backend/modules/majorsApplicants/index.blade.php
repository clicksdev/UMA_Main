                ...
                <div class="d-flex align-items-center flex-wrap mr-1">
                    ...
                    <div class="d-flex align-items-baseline flex-wrap mr-5">
                        ...
                        <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                            ...
                            <li class="breadcrumb-item text-muted">
                                <a href="{{ route('majorApplicants.index') }}"
                ...
                <div class="card card-custom">
                    ...
                    <div class="card-body">
                        <form id="exportForm" class="kt-form kt-form--fit mb-15" method="post"
                              action="{{ route('majorApplicants.export') }}">
                            @csrf
                            <div class="row">
                        ...
                        @if (\App\Models\MajorApplicant::count() > 0)
                            <!--begin: Datatable-->
    ...
    <script>
        $(document).ready(function () {
            var table = $('#myTable').DataTable({
                ...
                order: [],
                ajax: {
                    url: "{{ route('majorApplicants.datatable') }}",
                    data: function (d) {
            ...
            $('#rateModal').on('show.bs.modal', function (event) {
                ...
                $.ajax({
                    type: 'GET',
                    url: '{{ route("majorApplicants.getRating", ["majorApplicant" => ":applicantId"]) }}'.replace(':applicantId', applicantId),
            ...
            $('#ratingForm').submit(function (e) {
                ...
                $.ajax({
                    type: 'POST',
                    url: "{{ route('majorApplicants.updateRating') }}",
                    data: {
