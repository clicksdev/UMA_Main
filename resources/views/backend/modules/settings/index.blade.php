            ...
            <div class="card card-custom">
                ...
                <div class="card-body">
                    <ul class="nav nav-tabs" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active" data-toggle="tab" href="#site-info">{{ __('Site Information')
                                }}</a>
                        </li>
                        <li class="nav-item">
                    ...
                    <div class="tab-content mt-3">
                        <div id="site-info" class="tab-pane active">
                            <div class="form-group row">
                                <label class="col-form-label col-lg-3 col-sm-12 text-right">{{ __('Site Name')
                                    }}</label>
                                <div class="col-lg-7 col-md-9 col-sm-12">
                                    {{ Form::text('site_name', $settingsArray['site_name']['value'] ?? null,
                                    ['placeholder' => __('Site Name'), 'class' => $errors->has('site_name') ?
                                ...
                                <div class="col-lg-6">
                                    <div class="image-input image-input-outline image-input-circle" id="kt_image_1">
                                        ...
                                        <label
                                            ...
                                            {{ Form::file('logo', ['class' => 'd-none', 'accept' => '.png, .jpg,
                                            .jpeg']) }}
                        ...
                        <div id="shape-section" class="tab-pane">
                            <div class="form-group row">
                                <label class="col-form-label col-lg-3 col-sm-12 text-right">{{ __('Shape Section Title')
                                    }}</label>
                                <div class="col-lg-7 col-md-9 col-sm-12">
                                    {{ Form::text('shape_section_title', $settingsArray['shape_section_title']['value']
                                    ?? null, ['placeholder' => __('Title'), 'class' =>
                                    $errors->has('shape_section_title') ? 'form-control is-invalid' : 'form-control'])
                                    }}
                            ...
                            <div class="form-group row">
                                <label class="col-form-label col-lg-3 col-sm-12 text-right">{{ __('Shape Section
                                    Description') }}</label>
                                <div class="col-lg-7 col-md-9 col-sm-12">
                                    {{ Form::textarea('shape_section_description',
                                    $settingsArray['shape_section_description']['value'] ?? null, ['placeholder' =>
                                    __('Description'), 'class' => $errors->has('shape_section_description') ?
                                    'form-control is-invalid' : 'form-control']) }}
                        ...
                        <div id="our-aim" class="tab-pane">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-7 col-md-9 col-sm-12">
                                    ...
                                    ['placeholder' => __('Title'), 'class' => $errors->has('our_aim_title') ?
                                    'form-control is-invalid' : 'form-control']) }}
                            ...
                            <div class="form-group row">
                                <label class="col-form-label col-lg-3 col-sm-12">{{ __('OUR AIM Description') }}</label>
                                <div class="col-lg-7 col-md-9 col-sm-12">
                                    {{ Form::textarea('our_aim_description',
                                    $settingsArray['our_aim_description']['value'] ?? null, ['placeholder' =>
                                    __('Description'), 'class' => $errors->has('our_aim_description') ? 'form-control
                            ...
                            <div id="main-majors-description" class="tab-pane">
                                <div class="form-group row">
                                    <label class="col-form-label col-lg-3 col-sm-12">{{ __('Main Majors Description')
                                        }}</label>
                                    <div class="col-lg-7 col-md-9 col-sm-12">
                                        {{ Form::textarea('main_majors_description',
                                        $settingsArray['main_majors_description']['value'] ?? null, ['placeholder' =>
                                        __('Description'), 'class' => $errors->has('main_majors_description') ?
                                        'form-control is-invalid' : 'form-control']) }}
                            ...
                            <div id="online-courses-description" class="tab-pane">
                                <div class="form-group row">
                                    <label class="col-form-label col-lg-3 col-sm-12">{{ __('Online Courses Description')
                                        }}</label>
                                    <div class="col-lg-7 col-md-9 col-sm-12">
                                        {{ Form::textarea('online_courses_description',
                                        $settingsArray['online_courses_description']['value'] ?? null, ['placeholder' =>
                                        __('Description'), 'class' => $errors->has('online_courses_description') ?
                                        'form-control is-invalid' : 'form-control']) }}
                                        <div class="invalid-feedback">{{ $errors->first('online_courses_description') }}
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div id="how-it-works" class="tab-pane">
                            ...
                            <div class="form-group row">
                                <label class="col-form-label col-lg-3 col-sm-12">{{ __('How It Works Title') }}</label>
                                <div class="col-lg-7 col-md-9 col-sm-12">
                                    {{ Form::text('how_it_works_title', $settingsArray['how_it_works_title']['value'] ??
                                    null, ['placeholder' => __('Title'), 'class' => $errors->has('how_it_works_title') ?
                                    'form-control is-invalid' : 'form-control']) }}
                                    <div class="invalid-feedback">{{ $errors->first('how_it_works_title') }}</div>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-form-label col-lg-3 col-sm-12">{{ __('How It Works Description')
                                    }}</label>
                                <div class="col-lg-7 col-md-9 col-sm-12">
                                    {{ Form::textarea('how_it_works_description',
                                    $settingsArray['how_it_works_description']['value'] ?? null, ['placeholder' =>
                                    __('Description'), 'class' => $errors->has('how_it_works_description') ?
                                    'form-control is-invalid' : 'form-control']) }}
                                    <div class="invalid-feedback">{{ $errors->first('how_it_works_description') }}</div>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-7 col-md-9 col-sm-12">
                                    {{ Form::text('how_it_works_step_one_title',
                                    $settingsArray['how_it_works_step_one_title']['value'] ?? null, ['placeholder' =>
                                    __('Step One Title'), 'class' => $errors->has('how_it_works_step_one_title') ?
                                    'form-control is-invalid' : 'form-control']) }}
                            ...
                            <div class="form-group row">
                                <label class="col-form-label col-lg-3 col-sm-12">{{ __('Step One Description')
                                    }}</label>
                                <div class="col-lg-7 col-md-9 col-sm-12">
                                    {{ Form::textarea('how_it_works_step_one_description',
                                    $settingsArray['how_it_works_step_one_description']['value'] ?? null, ['placeholder'
                                    => __('Step One Description'), 'class' =>
                                    $errors->has('how_it_works_step_one_description') ? 'form-control is-invalid' :
                                    'form-control']) }}
                                    <div class="invalid-feedback">{{ $errors->first('how_it_works_step_one_description')
                                        }}</div>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-7 col-md-9 col-sm-12">
                                    {{ Form::text('how_it_works_step_two_title',
                                    $settingsArray['how_it_works_step_two_title']['value'] ?? null, ['placeholder' =>
                                    __('Step Two Title'), 'class' => $errors->has('how_it_works_step_two_title') ?
                                    'form-control is-invalid' : 'form-control']) }}
                            ...
                            <div class="form-group row">
                                <label class="col-form-label col-lg-3 col-sm-12">{{ __('Step Two Description')
                                    }}</label>
                                <div class="col-lg-7 col-md-9 col-sm-12">
                                    {{ Form::textarea('how_it_works_step_two_description',
                                    $settingsArray['how_it_works_step_two_description']['value'] ?? null, ['placeholder'
                                    => __('Step Two Description'), 'class' =>
                                    $errors->has('how_it_works_step_two_description') ? 'form-control is-invalid' :
                                    'form-control']) }}
                                    <div class="invalid-feedback">{{ $errors->first('how_it_works_step_two_description')
                                        }}</div>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-7 col-md-9 col-sm-12">
                                    {{ Form::text('how_it_works_step_three_title',
                                    $settingsArray['how_it_works_step_three_title']['value'] ?? null, ['placeholder' =>
                                    __('Step Three Title'), 'class' => $errors->has('how_it_works_step_three_title') ?
                                    'form-control is-invalid' : 'form-control']) }}
                                    <div class="invalid-feedback">{{ $errors->first('how_it_works_step_three_title') }}
                                    </div>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-form-label col-lg-3 col-sm-12">{{ __('Step Three Description')
                                    }}</label>
                                <div class="col-lg-7 col-md-9 col-sm-12">
                                    {{ Form::textarea('how_it_works_step_three_description',
                                    $settingsArray['how_it_works_step_three_description']['value'] ?? null,
                                    ['placeholder' => __('Step Three Description'), 'class' =>
                                    $errors->has('how_it_works_step_three_description') ? 'form-control is-invalid' :
                                    'form-control']) }}
                        ...
                        <div id="our-partners" class="tab-pane">
                            ...
                            <div class="form-group row">
                                <label class="col-form-label col-lg-3 col-sm-12">{{ __('Our Partners Image') }}</label>
                        ...
                        <div id="toggle-sections-2" class="tab-pane">
                            ...
                            <div class="form-check">
                                ...
                                <input class="form-check-input" type="checkbox" name="isShowOurMajor" id="flexCheckChecked2" value="1" {{isset($settingsArray['isShowOurMajor']) && $settingsArray['isShowOurMajor']['value'] == 1 ? "checked" : ""}}>
                            ...
                            <div class="form-check">
                                ...
                                <input class="form-check-input" type="checkbox" name="isShowPresedintSection" id="flexCheckChecked22" value="1" {{isset($settingsArray['isShowPresedintSection']) && $settingsArray['isShowPresedintSection']['value'] == 1 ? "checked" : ""}}>
                                <label class="form-check-label" for="flexCheckChecked22">Show Presedint words?</label>
                            </div>
                            <div class="form-check">
                                <input type="hidden" name="isShowAbout" value="0">
                                <input class="form-check-input" type="checkbox" name="isShowAbout" id="flexCheckChecked23" value="1" {{isset($settingsArray['isShowAbout']) && $settingsArray['isShowAbout']['value'] == 1 ? "checked" : ""}}>
                                <label class="form-check-label" for="flexCheckChecked23">Show About?</label>
                            </div>
                            <div class="form-check">
                                <input type="hidden" name="isShowOurAim" value="0">
                                <input class="form-check-input" type="checkbox" name="isShowOurAim" id="flexCheckChecked3" value="1" {{isset($settingsArray['isShowOurAim']) && $settingsArray['isShowOurAim']['value'] == 1 ? "checked" : ""}}>
                            ...
                            <div class="form-check">
                                ...
                                <input class="form-check-input" type="checkbox" name="isShowFeaturedCourses" id="flexCheckChecked4" value="1" {{isset($settingsArray['isShowFeaturedCourses']) && $settingsArray['isShowFeaturedCourses']['value'] == 1 ? "checked" : ""}}>
                            ...
                            <div class="form-check">
                                ...
                                <input class="form-check-input" type="checkbox" name="isShowHowItworks" id="flexCheckChecked5" value="1" {{isset($settingsArray['isShowHowItworks']) && $settingsArray['isShowHowItworks']['value'] == 1 ? "checked" : ""}}>
                            ...
                            <div class="form-check">
                                ...
                                <input class="form-check-input" type="checkbox" name="isShowStatistics" id="flexCheckChecked6" value="1" {{isset($settingsArray['isShowStatistics']) && $settingsArray['isShowStatistics']['value'] == 1 ? "checked" : ""}}>
                            ...
                            <div class="form-check">
                                ...
                                <input class="form-check-input" type="checkbox" name="isShowTestemonials" id="flexCheckChecked6" value="1" {{isset($settingsArray['isShowTestemonials']) && $settingsArray['isShowTestemonials']['value'] == 1 ? "checked" : ""}}>
                            ...
                            <div class="form-check">
                                ...
                                <input class="form-check-input" type="checkbox" name="isShowOurParteners" id="flexCheckChecked7" value="1" {{isset($settingsArray['isShowOurParteners']) && $settingsArray['isShowOurParteners']['value'] == 1 ? "checked" : ""}}>
                                <label class="form-check-label" for="flexCheckChecked7">Show Our Partners?</label>
                            </div>
                            <div class="form-check">
                                <input type="hidden" name="isShowNeverMiss" value="0">
                                <input class="form-check-input" type="checkbox" name="isShowNeverMiss" id="flexCheckChecked7" value="1" {{isset($settingsArray['isShowNeverMiss']) && $settingsArray['isShowNeverMiss']['value'] == 1 ? "checked" : ""}}>
                        ...
                        <div id="presedent-word-sections" class="tab-pane">
                            ...
                            <div class="col-lg-6">
                                <div class="image-input image-input-outline image-input-circle" id="kt_image_1">
                                    ...
                                    <label
                                        ...
                                        <i class="fa fa-pen icon-sm text-muted"></i>
                                        <!-- Replace the HTML input with Laravel Form::file() method -->
                                        {{ Form::file('persident_img', ['class' => 'd-none', 'accept' => '.png, .jpg,
                                        .jpeg']) }}
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-7 col-md-9 col-sm-12">
                                    {{ Form::text('presedent_name',
                                    (isset($settingsArray['presedent_name']) && $settingsArray['presedent_name']['value']) ? $settingsArray['presedent_name']['value'] : null, ['placeholder' =>
                                    "President Name", 'class' => $errors->has('presedent_name') ?
                                    'form-control is-invalid' : 'form-control']) }}
                            ...
                            <div class="form-group row">
                                <label class="col-form-label col-lg-3 col-sm-12">{{ __('President Position') }}</label>
                                <div class="col-lg-7 col-md-9 col-sm-12">
                                    {{ Form::text('presedent_position',
                                    $settingsArray['presedent_position']['value'] ?? null, ['placeholder' =>
                                    "President Position", 'class' => $errors->has('presedent_position') ?
                                    'form-control is-invalid' : 'form-control']) }}
                            ...
                            <div class="form-group row">
                                <label class="col-form-label col-lg-3 col-sm-12">{{ __('President Part word') }}</label>
                                <div class="col-lg-7 col-md-9 col-sm-12">
                                    {{ Form::textarea('presedent_word_part',
                                    $settingsArray['presedent_word_part']['value'] ?? null, ['placeholder' =>
                                    "President Part word", 'class' => $errors->has('presedent_word_part') ?
                                    'form-control is-invalid' : 'form-control']) }}
                        ...
                        <div id="about-sections" class="tab-pane">
                            <div class="form-group row">
                                ...
                                <div class="col-lg-7 col-md-9 col-sm-12">
                                    {{ Form::textarea('uma_vision',
                                    (isset($settingsArray['uma_vision']) && $settingsArray['uma_vision']['value']) ? $settingsArray['uma_vision']['value'] : null, ['placeholder' =>
                                    "UMA Vision", 'class' => $errors->has('uma_vision') ?
                                    'form-control is-invalid' : 'form-control']) }}
                                    <div class="invalid-feedback">{{ $errors->first('uma_vision') }}
                                    </div>
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-lg-7 col-md-9 col-sm-12">
                                    ...
                                    (isset($settingsArray['uma_mission']) && $settingsArray['uma_mission']['value']) ? $settingsArray['uma_mission']['value'] : null, ['placeholder' =>
                ...
                <div class="card-footer">
                    <div class="row">
                        ...
                        <div class="col-lg-2">
                            <button type="submit" class="btn font-weight-bold btn-primary mr-2">{{ __('sidebar.save')
                                }}</button>
                        </div>
                    </div>
                </div>
