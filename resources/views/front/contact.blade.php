...
<section class="contact_wrapper" style="margin-bottom: 80px">
    <div class="container">
        <div class="text">
            ...
            <br>
            <p>
                You can reach us through the official email of United Media Academy for all your inquiries:
            ...
            <P>
                ...
                <br>
                United Media Academy - 26th of July Corridor, Sheikh Zayed, Giza, Egypt
            </P>
        </div>
