...
<footer>
    ...
    <div class="container">
        <div class="main">
            ...
            <p>يعمل كمنارة للمعرفة والخبرة، ويسعى لتطوير المتخصصين الطموحين في الإعلام وتشكيل مستقبل الصناعة.</p>
        </div>
        <div class="links">
            <ul>
                <li><h2>البرامج</h2></li>
                @foreach ($latest_courses as $course)
                <li><a href="{{$course->isReady ? '/course/' . $course->id : "#"}}">{{ $course->title_ar }}</a></li>
                @endforeach
            </ul>
            <ul>
                <li><h2>روابط سريعة</h2></li>
                <li><a href="/our-programs">برامجنا</a></li>
    ...
    <div class="container">
        <span>© 2024 جميع الحقوق محفوظة 2024</span>
        <span><a href="">UMA</a> مدعوم من <a href="">Clicks</a></span>
    </div>
</footer>
@else
<footer>
